...
/**
 * AffiliationData describes the structure of a participant's affiliation info.
 */
interface AffiliationData {
  ...
  appearanceConfirmedDate?: string;
}

// Example static data for demonstration
const affiliationData: AffiliationData = {
...
/**
 * AffiliationPage displays the participant's affiliation data and allows
 * toggling appearance confirmation for the conference.
 */
export default function ChairmanAffiliationPage() {
  const [confirmed, setConfirmed] = useState(
    affiliationData.appearanceConfirmed,
  );
  const [confirmationDate, setConfirmationDate] = useState<string | undefined>(
    affiliationData.appearanceConfirmedDate,
  );

  /**
   * Handles toggling the appearance confirmation switch.
   * Updates confirmation date and shows a toast notification.
   */
  const handleConfirmToggle = (checked: boolean) => {
    ...
    if (checked) {
      ...
      toast({
        title: "Appearance Confirmed",
        description: "You have confirmed your appearance at the conference.",
        duration: 3000,
      });
    } else {
